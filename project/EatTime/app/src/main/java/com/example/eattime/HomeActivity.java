...
import com.example.eattime.Fragments.CartFragment;
import com.example.eattime.Fragments.HomeFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // check intent
        // neu login = true thi duoc access
        // neu login = false thi chi xem thoi!
        if (getIntent()!=null)
        {
